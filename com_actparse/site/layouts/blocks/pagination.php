 ...
 * @var  Registry $params      The params
 */
extract($displayData);
?>
<?php if ($params->get('show_pagination') and ($pagination->pagesTotal > 1)) : ?>
	<div class="com-actparse-<?php echo $view; ?>__navigation w-100">
		<?php if ($params->get('show_pagination_results', 1)) : ?>
			<p class="com-actparse-<?php echo $view; ?>__counter counter float-end pt-3 pe-2">
				<?php echo $pagination->getPagesCounter(); ?>
			</p>
		<?php endif; ?>
		<div class="com-actparse-<?php echo $view; ?>__pagination"
