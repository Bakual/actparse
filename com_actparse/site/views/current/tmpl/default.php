...
?>
<div class="com-actparse-current<?php echo $this->pageclass_sfx; ?> category-list">
	...
	<form action="<?php echo htmlspecialchars(Uri::getInstance()->toString()); ?>" method="post" id="adminForm"
		  name="adminForm" class="com-actparse-current__combatants">
		...
		<?php endif; ?>
		<?php echo LayoutHelper::render('blocks.pagination', array('view' => 'current', 'pagination' => $this->pagination, 'params' => $this->params)); ?>
