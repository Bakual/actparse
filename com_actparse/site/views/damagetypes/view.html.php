 ...
 */
class ActparseViewDamagetypes extends JView
{
	...
	protected function _prepareDocument()
	{
		...
		$this->subtitle	= JText::_('COM_ACTPARSE_DAMAGETYPES_FROM').' "'.$crumbs['combatant'].'"';
		if ($showpath) {
			...
			$path->addItem(JText::_('COM_ACTPARSE_DAMAGETYPES'));
		}
	}
}