	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th class="title">
					<?php echo JHtml::_('grid.sort',  'Raidname', 'raids.raidname', $listDirn, $listOrder); ?>
				</th>
				<th width="5%">
					<?php echo JHtml::_('grid.sort',  'JPUBLISHED', 'raids.published', $listDirn, $listOrder); ?>
				</th>
				<th width="5%">
					<?php echo JHtml::_('grid.sort',  'JDATE', 'raids.date', $listDirn, $listOrder); ?>
				</th>
